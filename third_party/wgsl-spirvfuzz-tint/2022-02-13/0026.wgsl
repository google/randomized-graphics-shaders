...
let x_117:mat3x3<f32>=mat3x3<f32>(vec3<f32>((7.0*x_23),(8.0*x_31),(x_31*(9.0*x_23))),vec3<f32>((10.0*x_23),(11.0*x_31),((12.0*x_23)*x_31)),vec3<f32>((13.0*x_23),(14.0*x_31),(x_31*(15.0*x_23))));
...
let x_203:vec3<f32>=(vec3<f32>(x_201.x,x_201.y,x_201.z)*(x_117*mat3x3<f32>(vec3<f32>((x_23*16.0),(17.0*x_31),((18.0*x_23)*x_31)),vec3<f32>((x_23*19.0),(x_31*20.0),((21.0*x_23)*x_31)),vec3<f32>((22.0*x_23),(x_31*23.0),((24.0*x_23)*x_31)))));
