...
let x_22:f32=x_15.polynomial[0];
let x_23:f32=*(x);
let x_29:f32=x_15.polynomial.y;
let x_30:f32=*(x);
let x_35:f32=x_15.polynomial.z;
return(x_35+((x_29*x_30)+(pow(x_23,2.0)*x_22)));
}
...
let x_104:f32=h1;
let x_106:f32=h0;
A=(((x_93*x_94)-(x_97*x_96))/((pow(x_100,2.0)*x_102)-(x_106*pow(x_104,2.0))));
let x_110:f32=k0;
let x_111:f32=A;
let x_112:f32=h0;
let x_116:f32=h0;
B=((x_110 -(pow(x_112,2.0)*x_111))/x_116);
let x_119:f32=x2;
param_4=x_119;
...
let x_130:f32=A;
let x_132:f32=C;
x2=(x_121 -((x_122*2.0)/((sqrt((pow(x_127,2.0)-((x_130*4.0)*x_132)))*sign(x_125))+x_124)));
let x_140:f32=x1;
x0=x_140;
let x_141:f32=temp;
x1=x_141;
...
let x_142:f32=x2;
let x_145:f32=x2;
if(((x_145>=-1.100000024)&(x_142<=-0.899999976))){
