...
let x_83:f32=((x_171+((pow(x_235,2.0)*x_161)+(x_166*x_235)))- x_187);
let x_75:f32=(x_234 - x_233);
let x_101:f32=pow(x_71,2.0);
let x_109:f32=(((x_83*x_75)-(((((x_234*x_166)+(pow(x_234,2.0)*x_161))+x_171)- x_187)*x_71))/((x_75*x_101)-(pow(x_75,2.0)*x_71)));
let x_117:f32=((x_83 -(x_109*x_101))/x_71);
x_139=(x_233 -((2.0*x_187)/(x_117+(sqrt((pow(x_117,2.0)-((4.0*x_109)*x_187)))*sign(x_117)))));
x_235_phi=x_234;
x_234_phi=x_233;
x_233_phi=x_139;
}
