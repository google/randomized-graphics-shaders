...
var i_3:i32=0;
var _injected_loop_counter:i32=0;
...
loop{
let _e78=_injected_loop_counter;
if(!((_e78!=(0^1)))){
break;
}
{
...
continuing{
let _e84=_injected_loop_counter;
_injected_loop_counter=(_e84+1);
}
}
}
continuing{
...
let _e92=sum;
sum=(_e92/vec3<f32>(16.0));
let _e96=sum;
_GLF_color=vec4<f32>(_e96.x,_e96.y,_e96.z,1.0);
return;
}
