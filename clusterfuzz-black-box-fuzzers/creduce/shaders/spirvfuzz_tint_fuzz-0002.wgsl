...
fn main_1() {
  ...
  loop {
    ...
    let x_222 : i32 = (x_508 + bitcast<i32>(1u));

    continuing {
      x_508_phi = x_222;
      if ((x_222 < bitcast<i32>(10u))) {
      } else {
        break;
      }
    }
  ...
  loop {
    ...
    loop {
      ...
      if ((x_519 < bitcast<i32>(9u))) {
      } else {
        break;
      }
      let x_405 : i32 = (x_519 + x_511);
      let x_406 : i32 = (x_405 - bitcast<i32>(1u));
      let x_410 : i32 = (x_519 + bitcast<i32>((2u * bitcast<u32>(x_511))));
      let x_413 : i32 = min((x_410 - bitcast<i32>(1u)), 9);
      x_532_phi = x_519;
      x_522_phi = x_405;
      x_521_phi = x_519;
      loop {
        ...
        let x_452 : i32 = *(x_451);
        let x_456 : i32 = bitcast<i32>((x_532 + bitcast<i32>(1u)));
        if ((x_449 < x_452)) {
          x_458 = bitcast<i32>((x_521 + bitcast<i32>(1u)));
          let x_460 : i32 = *(x_448);
          temp[x_532] = *(x_448);
          x_534_phi = x_522;
          x_533_phi = x_458;
        } else {
          x_466 = (x_522 + bitcast<i32>(1u));
          let x_468 : i32 = *(x_451);
          temp[x_532] = *(x_451);
          x_534_phi = x_466;
          x_533_phi = x_521;
      ...
      loop {
        ...
        if (((x_523 < bitcast<i32>(10u)) & (x_523 <= x_406))) {
        } else {
          break;
        }

        continuing {
          x_483 = (x_531 + bitcast<i32>(1u));
          x_485 = (x_523 + bitcast<i32>(1u));
      ...
      loop {
        ...
        continuing {
          let x_500 : ptr<function, i32> = &(temp[x_524]);
          let x_501 : i32 = *(x_500);
          data[x_524] = *(x_500);
          x_505 = (x_524 + bitcast<i32>(1u));
          x_524_phi = x_505;
        }
      }
  ...
  if ((x_248 < bitcast<i32>(30u))) {
    ...
    if ((x_248 < bitcast<i32>(60u))) {
      ...
      var x_515_phi : f32;
      if ((x_248 < 90)) {
        let x_284 : i32 = data[2u];
        x_287 = (0.5 + (f32(x_284) * 0.100000001));
        x_514_phi = x_287;
      } else {
        if ((x_248 < bitcast<i32>(120u))) {
          ...
          var x_517 : f32;
          var x_516_phi : f32;
          if ((x_248 < bitcast<i32>(150u))) {
            discard;
          } else {
            var x_337 : f32;
            var x_518 : f32;
            var x_517_phi : f32;
            if ((x_248 < bitcast<i32>(180u))) {
              ...
              var x_365 : f32;
              var x_518_phi : f32;
              if ((x_248 < bitcast<i32>(210u))) {
                let x_334 : i32 = data[6u];
                x_337 = (0.5 + (f32(x_334) * 0.100000001));
                x_517_phi = x_337;
              } else {
                if ((x_248 < bitcast<i32>(240u))) {
                  let x_348 : i32 = data[7u];
                  x_351 = (0.5 + (f32(x_348) * 0.100000001));
                  x_518_phi = x_351;
                } else {
                  if ((x_248 < bitcast<i32>(270u))) {
                  } else {
                    discard;
                  }
                  let x_362 : i32 = data[8u];
